...
namespace Sugar_Factory {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string stock, string description, System.DateTime manufacture_date, double price, int quantity, System.DateTime expiration_date) {
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public System.DateTime manufacture_date {
                get {
                    return ((global::System.DateTime)(this[this.tableProducts.manufacture_dateColumn]));
                }
                set {
                    this[this.tableProducts.manufacture_dateColumn] = value;
                }
            }
...
namespace Sugar_Factory.DatabaseDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([code] = @Original_code) AND ([stock] = @Original_stock) AND ([description] = @Original_description) AND ([manufacture_date] = @Original_manufacture_date) AND ([price] = @Original_price) AND ([quantity] = @Original_quantity) AND ([expiration_date] = @Original_expiration_date))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([stock], [description], [manufacture_date], [price], [quantity], [expiration_date]) VALUES (@stock, @description, @manufacture_date, @price, @quantity, @expiration_date);
SELECT code, stock, description, manufacture_date, price, quantity, expiration_date FROM Products WHERE (code = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [stock] = @stock, [description] = @description, [manufacture_date] = @manufacture_date, [price] = @price, [quantity] = @quantity, [expiration_date] = @expiration_date WHERE (([code] = @Original_code) AND ([stock] = @Original_stock) AND ([description] = @Original_description) AND ([manufacture_date] = @Original_manufacture_date) AND ([price] = @Original_price) AND ([quantity] = @Original_quantity) AND ([expiration_date] = @Original_expiration_date));
SELECT code, stock, description, manufacture_date, price, quantity, expiration_date FROM Products WHERE (code = @code)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT code, stock, description, manufacture_date, price, quantity, expiration_da" +
                "te FROM dbo.Products";
        ...
        public virtual int Delete(int Original_code, string Original_stock, string Original_description, System.DateTime Original_manufacture_date, double Original_price, int Original_quantity, System.DateTime Original_expiration_date) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((System.DateTime)(Original_manufacture_date));
        ...
        public virtual int Insert(string stock, string description, System.DateTime manufacture_date, double price, int quantity, System.DateTime expiration_date) {
            if ((stock == null)) {
                throw new global::System.ArgumentNullException("stock");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(stock));
            }
            if ((description == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((System.DateTime)(manufacture_date));
        ...
        public virtual int Update(string stock, string description, System.DateTime manufacture_date, double price, int quantity, System.DateTime expiration_date, int Original_code, string Original_stock, string Original_description, System.DateTime Original_manufacture_date, double Original_price, int Original_quantity, System.DateTime Original_expiration_date, int code) {
            if ((stock == null)) {
                throw new global::System.ArgumentNullException("stock");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((string)(stock));
            }
            if ((description == null)) {
                throw new global::System.ArgumentNullException("description");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((System.DateTime)(manufacture_date));
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((System.DateTime)(Original_manufacture_date));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string stock, string description, System.DateTime manufacture_date, double price, int quantity, System.DateTime expiration_date, int Original_code, string Original_stock, string Original_description, System.DateTime Original_manufacture_date, double Original_price, int Original_quantity, System.DateTime Original_expiration_date) {
            return this.Update(stock, description, manufacture_date, price, quantity, expiration_date, Original_code, Original_stock, Original_description, Original_manufacture_date, Original_price, Original_quantity, Original_expiration_date, Original_code);
        }
    }
